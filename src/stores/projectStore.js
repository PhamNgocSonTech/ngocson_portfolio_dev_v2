...
export const useProjectStore = defineStore('projects', () => {
    const projects = ref([
...

      {
        ...
        desc: 'Dream Diary Blog is a personal blogging website where the admin can create and manage posts on any topic from daily life. Built with Vue 3 and Firebase, it includes user authentication, profile editing, blog management, and admin controls — designed to be simple, responsive, and easy to use.',
...

      {
        ...
        title: 'Chit Chat',
        desc: 'Chit Chat is a real-time group chat website where users can create and manage chat rooms, invite friends, and communicate instantly. It supports room search, user join/leave notifications, private rooms, and live updates for all conversations.',
...

      {
        ...
        desc: 'Onstagrams is a social media web app that connects everyone. Users can register, verify their email, and share posts with single or multiple images. They can follow others, like or comment on posts, and manage their own timeline. The platform supports profile editing, password recovery, and real-time interaction for a seamless social experience.',
