  ...
  <section class="clients">
    <div class="main__container">
      <div class="client__inner">
        ...
        <h2 class="client__title">What I Build With
        </h2>
        <div class="client__list wow animate__bounceInRight">
          <!-- Client Group 1 -->
          <div class="client__group">
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--gg">
                <!-- <img src="./assets/icons/client-icon/gg.svg" alt="" class="client-item__logo"> -->
              ...
              <!-- <img src="./assets/icons/client-icon/gg-name.svg" alt="" class="client-item__name"> -->
              <span class="client-item__name">HTML</span>
            </a>
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--upwork">
                <!-- <img src="./assets/icons/client-icon/upwork.svg" alt="" class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
              ...
              <!-- <img src="./assets/icons/client-icon/upwork-name.svg" alt="" class="client-item__name"> -->
              <span class="client-item__name">CSS</span>
          ...
          <div class="client__group">
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--wb">
                <!-- <img src="./assets/icons/client-icon/wb.svg" alt="" class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
              ...
              <!-- <img src="./assets/icons/client-icon/wb-name.svg" alt="" class="client-item__name"> -->
              <span class="client-item__name">Javascript</span>
            </a>

            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--cloud">
                <!-- <img src="./assets/icons/client-icon/creative-cloud.svg" alt=""
                    class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
                  <path fill="#388e3c"
              ...
              <!-- <img src="./assets/icons/client-icon/creative-cloud-name.svg" alt=""
                  class="client-item__name"> -->
              <span class="client-item__name">NodeJS</span>
          ...
          <div class="client__group">
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--mail">
                <!-- <img src="./assets/icons/client-icon/mail-chimp.svg" alt=""
                    class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                     viewBox="0 0 48 48">
                  <linearGradient id="jOxEAtqKLV9JfRrHHmqLMa_BUnExfsRs3CW_gr1" x1="3.381"
                                  x2="44.593" y1="25.73" y2="25.73" gradientUnits="userSpaceOnUse">
                  ...
                  <linearGradient id="jOxEAtqKLV9JfRrHHmqLMb_BUnExfsRs3CW_gr2" x1="11.146"
                                  x2="36.828" y1="19" y2="19" gradientUnits="userSpaceOnUse">
                  ...
                  <polygon fill="none"
                           points="23.987,30 36.828,8 29.24,8 23.987,17 18.734,8 11.146,8"></polygon>
              ...
              <!-- <img src="./assets/icons/client-icon/mail-chimp-name.svg" alt=""
                  class="client-item__name"> -->
              <span class="client-item__name">VueJS</span>

            </a>
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--woo">
                <!-- <img src="./assets/icons/client-icon/woocommerce.svg" alt=""
                    class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
                  <path fill="#f06292"
              ...
              <!-- <img src="./assets/icons/client-icon/woocommerce-name.svg" alt=""
                  class="client-item__name"> -->
              <span class="client-item__name">Sass</span>
          ...
          <div class="client__group">
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--adobe">
                <!-- <img src="./assets/icons/client-icon/adobe.svg" alt="" class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
                  <path fill="#00796b"
              ...
              <!-- <img src="./assets/icons/client-icon/adobe-name.svg" alt="" class="client-item__name"> -->
              <span class="client-item__name">MySQL</span>

            </a>
            <a href="#!" class="client__item">
              <div class="client-item__logo-wrapper client--canva">
                <!-- <img src="./assets/icons/client-icon/canva.svg" alt="" class="client-item__logo"> -->
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                     viewBox="0 0 48 48">
                  <path fill="#5d4037"
              ...
              <!-- <img src="./assets/icons/client-icon/canva-name.svg" alt="" class="client-item__name"> -->
              <span class="client-item__name">MongoDB</span>
            </a>
          </div>
        </div>
      </div>
